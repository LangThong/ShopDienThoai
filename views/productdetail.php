                ...
                <div class="product__details__pic">
                    ...
                    <div class="product__details__slider__content">
                        <div class="product__details__pic__slider owl-carousel">
                            ...
                            <img data-hash="product-4" class="product__big__img" src="upload/<?=$image?>" alt="">
                            <img data-hash="product-5" class="product__big__img" src="upload/<?=$image?>" alt="">
                            <img data-hash="product-6" class="product__big__img" src="upload/<?=$image?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
